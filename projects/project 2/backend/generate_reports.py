...
def generate_pdf_report():
    ...
    story.append(Paragraph(f"<b>Retail Business Analytics Report</b><br/>Generated: {datetime.now().strftime('%B %d, %Y')}", subtitle_style))
...
def generate_pptx_presentation():
    ...
    p2 = tf.add_paragraph()
    p2.text = "Retail Business Analytics & Performance Report"
    p2.font.name = "Arial"
    p2.font.size = Pt(18)
